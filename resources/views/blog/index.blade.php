                    ...
                    @foreach($categories as $cat)
                        <li>
                            <a href="{{ route('blog.category', $cat->slug) }}"
                               class="text-gray-600 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 {{ isset($category) && $category->id === $cat->id ? 'font-bold text-primary-600 dark:text-primary-400' : '' }}">
